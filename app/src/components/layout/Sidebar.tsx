...
import { Home, BookOpen, User, Settings, Trophy } from "lucide-react";
  ...
  return (
    <aside className="w-64 border-r bg-background h-screen flex flex-col">
      ...
      <nav className="flex-1 px-4 space-y-2">
        <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md hover:bg-accent hover:text-accent-foreground">
        ...
        <Link href="/leaderboard" className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md hover:bg-accent hover:text-accent-foreground">
